...
def main(argv=None):
    ...
    argParser = argparse.ArgumentParser( 
        description="Parse argument for preprocessing")
    
    argParser.add_argument('--workflowName', 
        help='A workflow name',
        dest='workflowName', 
        required =False, 
        default='MALFPreprocessingWF')
    argParser.add_argument('--inputListFilename', 
        help='A file name contains input list',
        dest='inputListFilename', 
        required = True)
    argParser.add_argument('--inputAtlas', 
        help='A input template atlas with brain clipped',
        dest='inputAtlas', 
        required = True)
    argParser.add_argument('--outputDirectory', 
        help='A directory that will contain output',
